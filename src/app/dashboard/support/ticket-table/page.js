            ...
            <div className="relative flex items-center justify-center">
              {row.StatusType === "Open" && (
                <div className="relative inline-block">
                  <button
                    className="px-4 py-1.5 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-500 dark:from-[#2fd9d3] dark:to-[#18c7c2] text-white dark:text-[#04131a] font-bold text-xs border-none cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(20,184,166,0.3)]"
                    onClick={async () => {
                      setSelectedTicket(row);
                      setModalOpen(true);
