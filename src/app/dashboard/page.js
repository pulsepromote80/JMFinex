    ...
    <div className={`min-h-screen  text-gray-900 dark:text-white`}>
      ...
      {showSimplePopup && isKidOne && !shouldBotBeActive && (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={(e) => { if (e.target === e.currentTarget) closeSimplePopup(); }}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <button type="button" className="absolute top-3 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onClick={closeSimplePopup} aria-label="Close">✕</button>
            <div className="p-6 text-center">
              ...
              <h5 className="text-xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-500 dark:from-teal-400 dark:to-blue-400">🤖 Trading Bot Activation Required</h5>
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-2">Dear Investor,</p>
              <p className="text-sm mb-3 text-gray-700 dark:text-gray-300">To start receiving your trading income, please activate the AI Trading Bot once from your dashboard.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 text-sm text-blue-700 dark:text-blue-300 mb-2">⚡ After activation, the system will automatically connect your account with the trading engine and your trading income process will begin.</div>
            </div>
          </div>
        </div>
      )}
      ...
      {showBuyPackagePopup && isKidFive && !shouldBotBeActive && (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={(e) => { if (e.target === e.currentTarget) closeBuyPackagePopup(); }}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <button type="button" className="absolute top-3 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onClick={closeBuyPackagePopup} aria-label="Close">✕</button>
            <div className="p-6 text-center">
              ...
              <h5 className="text-xl font-bold mb-3 text-amber-600 dark:text-amber-400">📦 Package Purchase Required</h5>
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-2">Dear Investor,</p>
              <p className="text-sm mb-3 text-gray-700 dark:text-gray-300">Please purchase a trading package to activate your AI Trading Bot.</p>
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3 text-sm text-amber-700 dark:text-amber-300 mb-2">🛒 Choose a package that suits your investment goals and start earning!</div>
            </div>
          </div>
        </div>
      )}
      ...
      {showCongratsPopup && (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4" onClick={(e) => { if (e.target === e.currentTarget) closeCongratsPopup(); }}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <button type="button" className="absolute top-3 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onClick={closeCongratsPopup} aria-label="Close">✕</button>
            <div className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500 dark:from-emerald-400 dark:to-teal-400 mb-1">🎉 Woo Hoo! 🎉</div>
              <div className="text-lg font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-emerald-500 dark:from-amber-400 dark:to-emerald-400">Bot Activated Successfully!</div>
              <p className="text-sm mb-2 text-gray-700 dark:text-gray-300">Your AI Trading Bot is now live and actively monitoring the markets!</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">🚀 The bot has started scanning for profitable opportunities</p>
            </div>
          </div>
        </div>
      )}
      ...
      {showBotPopup && isKidOne && !shouldBotBeActive && (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" id="botOv" onClick={(e) => { if (e.target === e.currentTarget) closeBotFullPopup(); }}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            <div className="h-1 bg-gradient-to-r from-teal-400 to-blue-400"></div>
            <button type="button" className="absolute top-3 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onClick={closeBotFullPopup} aria-label="Close">✕</button>
            <div className="p-6">
              <div className="flex gap-4 mb-4">
                ...
                <div>
                  <div className="font-bold text-lg mb-1 text-gray-900 dark:text-white">🤖 Trading <span className="text-teal-600 dark:text-teal-400">Bot Activation Required</span></div>
                  <div className="text-sm text-gray-500 dark:text-gray-400 leading-snug">Dear Investor, To start receiving your trading income, please activate the AI Trading Bot once from your dashboard.</div>
                </div>
              </div>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 text-sm text-blue-700 dark:text-blue-300 mb-4">⚡ After activation, the system will automatically connect your account with the trading engine and your trading income process will begin.</div>
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <label htmlFor="approveTrading" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">I understand and approve automated trading execution.</label>
              </div>
              <button className="w-full bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 text-gray-50 font-bold py-3 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed" onClick={activateBot} disabled={shouldBotBeActive || !isCheckboxChecked}>
      ...
      {showRefPopup && (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" id="refOv" onClick={(e) => { if (e.target === e.currentTarget) closeRef(); }}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <button type="button" className="absolute top-3 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onClick={closeRef} aria-label="Close">✕</button>
            <div className="p-6">
              <div className="text-center mb-4">
                <div className="text-lg font-bold mb-1 text-gray-900 dark:text-white">Invite &amp; <span className="text-teal-600 dark:text-teal-400">Earn</span></div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Share your link · Earn up to <strong className="text-amber-500">8% commission</strong> on every trade — 3 levels deep, paid daily</div>
              </div>
              <div className="grid grid-cols-3 gap-2 mb-4 text-center">
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3"><div className="font-bold text-teal-600 dark:text-teal-400">12</div><div className="text-xs text-gray-500 dark:text-gray-400">Referrals</div></div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3"><div className="font-bold text-emerald-600 dark:text-emerald-400">$841</div><div className="text-xs text-gray-500 dark:text-gray-400">Earned</div></div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3"><div className="font-bold text-blue-500">$92k</div><div className="text-xs text-gray-500 dark:text-gray-400">Team Vol</div></div>
              </div>
              <div className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">Your Unique Referral Link</div>
              <div className="font-mono text-xs bg-gray-100 dark:bg-gray-700 rounded-xl p-3 border border-dashed border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-200 break-all mb-3">https://arbion.ai/ref/ARB-a9x7k2-premium</div>
              <button className="w-full bg-gradient-to-r from-teal-600 to-blue-500 hover:from-teal-700 hover:to-blue-600 text-white font-bold py-3 rounded-xl transition-all mb-4" onClick={copyRef}>{copySuccess ? "✓ Copied!" : "Copy Referral Link"}</button>
              <div className="grid grid-cols-3 gap-2 mb-4 text-center">
                <div className="rounded-xl p-3 border border-emerald-200 dark:border-emerald-800 bg-emerald-50/50 dark:bg-emerald-900/20"><div className="font-bold text-emerald-600 dark:text-emerald-400">8%</div><div className="text-xs text-gray-500 dark:text-gray-400">Level 1</div></div>
                <div className="rounded-xl p-3 border border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-900/20"><div className="font-bold text-blue-500">5%</div><div className="text-xs text-gray-500 dark:text-gray-400">Level 2</div></div>
                <div className="rounded-xl p-3 border border-purple-200 dark:border-purple-800 bg-purple-50/50 dark:bg-purple-900/20"><div className="font-bold text-purple-500">3%</div><div className="text-xs text-gray-500 dark:text-gray-400">Level 3</div></div>
              </div>
              <div className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">Share on Social Media</div>
      ...
      {/* <div className="container mx-auto sm:px-6"> */}
        ...
        <div className="mt-6 mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Quick Actions</h5>
        </div>
        <div className="grid grid-cols-4 sm:grid-cols-7 gap-3 mb-6">
          {quickActions.map((qa) => (
            ...
            >
              ...
              <span className="text-xs font-semibold text-gray-700 dark:text-gray-300 text-center">{qa.label}</span>
            </button>
          ))}
        </div>
        ...
        {/* RANK & PACKAGE */}
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Accelerator Rank</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Your premium rank achievement system</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          <div className="bg-white  rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div className="text-sm font-bold text-gray-900 dark:text-white mb-1">Your Rank Journey</div>
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-4">Your premium rank achievement system</div>
            <div className="flex flex-wrap items-center gap-6">
              ...
              <div className="flex-1 min-w-[140px]">
                <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Current Business</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-white">₹{Number(dashboardData?.[0]?.TeamBusiness || 0).toLocaleString('en-IN')}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Next Rank</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-white">{dashboardData?.[0]?.NextRank || 'V2'}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Required Business</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-white">₹10,00,000</span>
                </div>
                <div className="flex items-center justify-between py-2">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Remaining</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-white">₹2,50,000</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div className="flex justify-between items-center mb-4">
              <div className="text-sm font-bold text-gray-900 dark:text-white">Trading Package</div>
              <span className="text-xs font-semibold px-3 py-1 rounded-full bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400">${dashboardData?.[0]?.TotalInvestment || "0.00"}</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div><div className="text-xs text-gray-500 dark:text-gray-400">Total Income</div><div className="font-bold text-teal-600 dark:text-teal-400">${(dashboardData?.[0]?.TotalIncome || 0).toFixed(2) || "0.00"}</div></div>
              <div><div className="text-xs text-gray-500 dark:text-gray-400">Max Limit</div><div className="font-bold text-amber-500">${(dashboardData?.[0]?.EarningLimit || 0).toFixed(2) || "0.00"}</div></div>
              <div><div className="text-xs text-gray-500 dark:text-gray-400">Remaining</div><div className="font-bold text-emerald-600 dark:text-emerald-400">${(dashboardData?.[0]?.RemainingLimit || 0).toFixed(2) || "0.00"}</div></div>
            </div>
          </div>
        </div>
        ...
        {/* INCOME OVERVIEW */}
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Income Overview</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Your earnings across all Roventar income streams</p>
        </div>
          ...
          {[
            ...
            <div key={item.key} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 cursor-pointer hover:-translate-y-0.5 hover:shadow-md transition-all" role="button" onClick={() => router.push(item.path)}>
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400">↗ ${item.today}</span>
              </div>
        ...
        {/* WALLET OVERVIEW */}
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Wallet Overview</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Manage your Roventar wallet balances</p>
        </div>
          ...
          {wallets.map((w) => (
            <div key={w.key} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
              <div className="flex justify-between items-start mb-3">
                ...
                <span className="text-xs font-bold px-3 py-1 rounded-full bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400">Active</span>
              </div>
              ...
              <div className="flex gap-2">
                <button type="button" className="flex-1 border border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 text-gray-700 dark:text-gray-300 font-semibold py-2.5 rounded-xl transition-all text-sm" onClick={() => router.push('/user/dashboard/wallet')}>View Wallet</button>
                <button type="button" className="flex-1 bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 text-gray-50 font-bold py-2.5 rounded-xl transition-all text-sm" onClick={w.onPrimary}>{w.primaryLabel}</button>
              </div>
            </div>
          ))}
        </div>
        ...
        {/* BOT + SUMMARY */}
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">AI Trading Engine</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Live bot status and your summary report</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5 relative overflow-hidden">
            <div className="flex flex-wrap justify-between items-start gap-3 mb-4">
              <div className="flex gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-gray-900 dark:text-white">Roventar AI Engine</div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">AI-driven Forex &amp; Crypto trading engine operating 24/7 — automatically scanning market trends and executing profitable trading opportunities with high-speed precision.</p>
            <div className="grid grid-cols-4 gap-2 text-center mb-4">
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-2.5">
                <div className="font-bold text-gray-900 dark:text-white">{dashboardData?.[0]?.Bot || 'N/A'}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Bot</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-2.5">
                <div className="font-bold text-gray-900 dark:text-white">~{dashboardData?.[0]?.APY}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">APY</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-2.5">
                <div className="font-bold text-gray-900 dark:text-white" id="powerBoosterStatus">{dashboardData?.[0]?.PowerBoosterStatus}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Boost Status</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-2.5">
                <div className="font-bold text-gray-900 dark:text-white">{dashboardData?.[0]?.BoosterValue}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Boost Power</div>
              </div>
            </div>
            <button
              className="w-full bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 text-gray-50 font-bold py-2.5 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed mb-3"
              onClick={() => {
            ...
            {shouldBotBeActive && (
              <div className="flex flex-wrap items-center gap-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-3" id="botNotif2">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300"><strong>Your Bot is now ACTIVATED!</strong> — Scanning 142+ opportunities/min across SOL, ETH &amp; BSC. First profit expected within 60 seconds.</span>
                <div className="flex items-center gap-2 bg-emerald-50 dark:bg-emerald-900/30 px-3 py-1 rounded-full text-xs font-bold text-emerald-700 dark:text-emerald-300" id="timerBox2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div className="flex justify-between items-start mb-4">
              <div className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Summary Report Status</div>
              <span className="text-xs font-semibold px-3 py-1 rounded-full bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 flex items-center gap-1.5 cursor-pointer" role="button" onClick={openRef}>
        ...
        {/* BUSINESS OVERVIEW */}
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Business Overview</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Your team&apos;s collective trading business</p>
        </div>
        ...
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Direct Team Performance</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Track your directly sponsored members</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400">Total Direct</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
            <StatIcon tone="green">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400">Active Direct</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
            <StatIcon tone="teal">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400">Direct Business</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
            <StatIcon tone="gold">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-2 mb-1">Level Open</div>
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 flex items-center gap-1.5">
        ...
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Growth Rewards</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Build your business. Unlock your next milestone.</p>
        </div>
        <div className="bg-gradient-to-r from-teal-900 to-slate-800 rounded-2xl p-5 mb-6 text-white shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-center">
            <div className="lg:col-span-2">
              <div className="text-xs font-bold uppercase tracking-wider text-teal-300/80 mb-1">Current Milestone</div>
              ...
              <div className="grid grid-cols-3 gap-3 mt-3">
                <div><div className="text-xs text-teal-300/70">Business Requirement</div><div className="font-bold text-gray-50">₹{Number(growthLevels[activeGrowthIdx]?.required).toLocaleString('en-IN')}</div></div>
                <div><div className="text-xs text-teal-300/70">Current Business</div><div className="font-bold text-gray-50">₹{Number(growthLevels[activeGrowthIdx]?.current).toLocaleString('en-IN')}</div></div>
                <div><div className="text-xs text-teal-300/70">Remaining</div><div className="font-bold text-gray-50">₹{Math.max(0, Number(growthLevels[activeGrowthIdx]?.required) - Number(growthLevels[activeGrowthIdx]?.current)).toLocaleString('en-IN')}</div></div>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5 mb-6">
          <div className="font-bold text-gray-900 dark:text-white mb-4">Growth Reward Journey</div>
          ...
          <div className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">Milestone Details</div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Level</th>
                  <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Business Required</th>
                  <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Current Business</th>
                  <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Reward</th>
                  <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Status</th>
                </tr>
              </thead>
              <tbody>
                {growthLevels.map((g, i) => {
                  ...
                  return (
                    <tr key={g.level} className="border-b border-gray-100 dark:border-gray-700/50 last:border-b-0">
                      ...
                      <td className="py-2.5 px-2"><span className={`text-xs font-bold px-3 py-1 rounded-full ${statusClass}`}>{status}</span></td>
                    </tr>
                  );
                })}
              </tbody>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div className="font-bold text-gray-900 dark:text-white mb-4">Your Rank Journey</div>
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4">
              {rankLevels.map((r) => (
                <div key={r.rank} className={`rounded-xl p-2.5 text-center border ${
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">{r.business}</div>
            ...
            <div className="border border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-4">
              <div className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1">Your Next Milestone</div>
              <div className="text-sm font-bold text-gray-900 dark:text-white mb-1">Grow your team business by ₹2,50,000</div>
              <div className="text-xs text-gray-500 dark:text-gray-400 mb-3">You are only 25% away from Accelerator {dashboardData?.[0]?.NextRank || 'V2'}.</div>
              <div className="flex flex-wrap gap-2 mb-3">
                <span className="text-xs font-semibold px-3 py-1.5 rounded-full bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300">Build active team</span>
                <span className="text-xs font-semibold px-3 py-1.5 rounded-full bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300">Increase direct business</span>
                <span className="text-xs font-semibold px-3 py-1.5 rounded-full bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300">Improve team volume</span>
              </div>
              <button type="button" className="bg-teal-400 text-gray-50 font-bold py-2 px-5 rounded-xl transition-all text-sm" onClick={() => router.push('/dashboard/team')}>View Business</button>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div className="flex flex-wrap justify-between items-end gap-2 mb-3">
              <div>
                <h5 className="text-sm font-bold text-gray-900 dark:text-white">Recent Transactions</h5>
                <p className="text-xs text-gray-500 dark:text-gray-400">Your latest wallet activity</p>
              </div>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Date</th>
                    <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">ID</th>
                    <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Type</th>
                    <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Wallet</th>
                    <th className="text-right py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Amount</th>
                    <th className="text-left py-2 px-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Status</th>
                  </tr>
                </thead>
                <tbody>
                  {recentTransactions.map((t) => (
                    <tr key={t.id} className="border-b border-gray-100 dark:border-gray-700/50 last:border-b-0">
                      <td className="py-2.5 px-2 text-gray-600 dark:text-gray-400 text-xs">{t.date}</td>
                      <td className="py-2.5 px-2 font-mono text-xs text-gray-700 dark:text-gray-300">{t.id}</td>
                      <td className="py-2.5 px-2 text-gray-700 dark:text-gray-300 text-xs">{t.type}</td>
                      <td className="py-2.5 px-2 text-gray-700 dark:text-gray-300 text-xs">{t.wallet}</td>
                      <td className={`py-2.5 px-2 text-right font-bold text-xs ${t.amount.startsWith('-') ? 'text-red-600 dark:text-red-400' : 'text-emerald-600 dark:text-emerald-400'}`}>{t.amount}</td>
        ...
        {/* BOTTOM ROW */}
        <div className="mb-3">
          <h5 className="text-base font-bold text-gray-900 dark:text-white">Support &amp; Updates</h5>
          <p className="text-sm text-gray-500 dark:text-gray-400">Assistant help and the latest Roventar notifications</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div className="flex justify-between items-center mb-4">
              <div className="text-sm font-bold text-gray-900 dark:text-white">Recent Achievements</div>
              <span className="text-xs font-semibold px-3 py-1 rounded-full bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400">{recentAchievements.length}</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400">{notificationCount} items</div>
            </div>
                ...
                notificationList.map((n, i) => (
                  <div key={(n.URID || i) + i} className={`p-3 rounded-xl border ${n.Seen ? 'bg-gray-50 dark:bg-gray-700/30 border-gray-200 dark:border-gray-700' : 'bg-amber-50/50 dark:bg-amber-900/10 border-amber-200 dark:border-amber-800'}`}>
                    <div className="flex justify-between gap-2">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400 flex-shrink-0">{n.Amount || ''}</div>
                    </div>
                  </div>
                ))
              ) : (
                <>
                  <div className="p-3 rounded-xl bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800">
                    <div className="flex justify-between mb-1">
                      <span className="text-xs font-bold text-teal-600 dark:text-teal-400">UPDATE</span>
                  ...
                  <div className="p-3 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                    <div className="flex justify-between mb-1">
                      <span className="text-xs font-bold text-red-600 dark:text-red-400">ALERT</span>
                      <span className="text-xs text-gray-500 dark:text-gray-400">8m ago</span>
                    </div>
                  ...
                  <div className="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800">
                    <div className="flex justify-between mb-1">
                      <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400">NEWS</span>
