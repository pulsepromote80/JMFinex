  ...
  const options = {
    ...
    scales: {
      x: {
        ...
        ticks: { color: '#8ea0c6', font: { size: 9 }, maxTicksLimit: 6 },
      },
      y: {
        display: true, grid: { color: 'rgba(15, 45, 100, 0.1)' },
        ticks: {
          color: '#8ea0c6', font: { size: 9 },
  ...
  return (
    <div className="h-full">
      <div className="flex justify-between items-center mb-2">
        <div>
          <div className="text-[18px] font-semibold text-[#eef3fb]" style={{ fontFamily: DISPLAY_FONT }}>
        ...
        <div className="text-[10px] text-[#8ea0c6]">BTC/USDT</div>
      </div>
        ...
        <div className="px-4 sm:px-7 py-6 pb-20 max-w-[1440px] mx-auto">
          ...
          <section className="mb-11">
            <div
              ...
              style={{
                background: "linear-gradient(120deg, #0a1428 0%, #0e1c38 55%, #101f3f 100%)",
...
>
                ...
                <p className="text-sm max-w-[440px] leading-[1.7] text-[#b7c3de]">
                ...
                <div className="text-[11px] text-[#8ea0c6] mt-3.5">
                ...
                <div className="flex flex-wrap gap-2.5 mt-5">
                  {ticker.map((t) => (
                    <div key={t.pair} className="rounded-xl px-3 py-2 min-w-[98px] bg-white/[.06] border border-[rgba(15,45,100,.13)]">
                      <div className="text-[10.5px] text-[#8ea0c6]">{t.pair}</div>
              ...
              <div className="relative z-10 rounded-2xl h-[280px] p-[18px] bg-[rgba(6,11,22,.55)] border border-[rgba(15,45,100,.13)]">
                <div className="flex justify-between text-[10px] tracking-[.08em] text-[#8ea0c6] mb-2.5">
