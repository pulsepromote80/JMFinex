              ...
              <div className="flex-1 min-w-[200px]">
                <div className="mb-4">
                  ...
                  <select
                    id="wallet-type"
                    name="walletType"
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#142936] text-gray-900 dark:text-[#eaf5f7] text-sm outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-all"
                    value={walletType}
                        ...
                        <div className="flex-1 min-w-[150px]">
                          <div className="mb-1">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#142936] text-gray-900 dark:text-[#eaf5f7] text-sm outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                              disabled={walletType === ""}
                            />
                          ...
                          <button
                            ...
                            className={`w-full px-5 py-2.5 rounded-xl text-white font-semibold text-sm transition-all ${
                              (isOtpSent || walletType === "") 
                                ...
                                : 'bg-gradient-to-r from-blue-400 to-blue-400 hover:from-blue-700 hover:to-blue-500'
                            }`}
