                            ...
                            <div className="flex-1">
                              <div>
                                ...
                                <div className="mb-4">
                                  ...
                                  <div>
                                    <span className="inline-block px-3 py-1.5 rounded-full bg-blue-200 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 text-sm font-semibold text-blue-700 dark:text-blue-400">
