...
import { getAllUserROIWithdrawalRequest } from '@/app/redux/slices/fundManagerSlice';
...
const WithdrawalHistory = () => {
  ...
  const { roiRequestData, loading, error } = useSelector((state) => state.fundManager);
  ...
  const handleExport = () => {
    if (!roiRequestData?.aprWithROI || roiRequestData?.aprWithROI?.length === 0) {
      toast.error("No data available to export");
      return;
    }

    const worksheet = XLSX.utils.json_to_sheet(
      roiRequestData?.aprWithROI?.map((txn, index) => ({
        "Sr.No.": index + 1,
  ...
  const allRows = roiRequestData?.aprWithROI || [];
      ...
      <div >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm mt-1 flex items-center gap-2">
                ...
                View and manage all ROI withdrawal requests
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-4">
            ...
            <p className="text-emerald-100 text-sm mt-1">Filter ROI history by date, user, or status</p>
          </div>
          ...
          <>
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400 font-medium">Loading ROI history...</p>
              </div>
            ) : error ? (
                        ...
                        <tr>
                          <td colSpan="13" className="px-6 py-12 text-center">
                            <div className="flex flex-col items-center gap-3">
                              ...
                              <p className="text-gray-500 dark:text-gray-400 font-medium">No ROI transactions found</p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 font-medium">No ROI withdrawal history found</p>
                <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Try adjusting your search criteria</p>
              </div>
            )}
          </>
