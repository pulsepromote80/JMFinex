      ...
      <header className="flex items-center gap-3 px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-[#10222e] backdrop-blur-[28px] saturate-[1.5] sticky top-0 transition-colors duration-300 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="relative" ref={notifyRef}>
            ...
            {notificationsDropDown && (
              <div
                ...
                className="absolute right-0 top-[calc(100%+10px)] w-72 max-w-[calc(100vw-20px)] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl z-[999] overflow-hidden"
              >
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            {showUserMenu && (
              <div className="absolute right-0 top-[calc(100%+10px)] w-48 max-w-[calc(100vw-20px)] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl z-[999] overflow-hidden py-1">
                <Link
